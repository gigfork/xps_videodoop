...
public class generateClass
{
	...
	public generateClass() throws Exception {
		...
		FileInputStream fstream = new FileInputStream("/home/rohit/Documents/Hadoop Program Data/VRP/copy1.txt");
	...
	{
		FileWriter fstream = new FileWriter("/home/rohit/Documents/Hadoop Program Data/VRP/type.txt");
		BufferedWriter out = new BufferedWriter(fstream);		
		Random rnd = new Random();
		
		FileWriter fstreamd = new FileWriter("/home/rohit/Documents/Hadoop Program Data/VRP/distance.txt");
	...
	{
		 FileInputStream fstream = new FileInputStream("/home/rohit/Documents/Hadoop Program Data/VRP/speed.txt");
		 DataInputStream in = new DataInputStream(fstream);
		 BufferedReader br = new BufferedReader(new InputStreamReader(in));
		 String line;
	...
	{		
		FileWriter fstream = new FileWriter("/home/rohit/Documents/Hadoop Program Data/VRP/pop_out.txt");
		BufferedWriter out = new BufferedWriter(fstream);
		...
		// 1/3 Random		
		for(int i=1;i<=numReducers*100;i++)
		{
		...
		InputStream in = new BufferedInputStream(new FileInputStream("/home/rohit/Documents/Hadoop Program Data/VRP/pop_out.txt"));
